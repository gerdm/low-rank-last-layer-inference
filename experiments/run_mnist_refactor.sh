...
python -W ignore run_mnist_bandit.py run-predictive-bayes --base_path output --num_trials $num_trials --agent FLoRESLite --num_steps $num_steps --key $key
...
python -W ignore run_mnist_bandit.py run-predictive-bayes --base_path output --num_trials $num_trials --agent LRKF --num_steps $num_steps --key $key
...
python -W ignore run_mnist_bandit.py run-predictive-bayes --base_path output --num_trials $num_trials --agent muon --num_steps $num_steps  --key $key